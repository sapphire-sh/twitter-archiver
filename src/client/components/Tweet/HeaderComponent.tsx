...
import { updateHistoryIfNeeded } from '~/client/actions';
import { ProfileComponent } from '~/client/components';
...
export class HeaderComponent extends React.Component<ComponentProps> {
  ...
  public render() {
    const { tweet, isRetweet, isQuote } = this.props;

    const { id_str, user, source, created_at } = tweet;
