...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tweet = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'a',
					{ href: "https://twitter.com/" + tweet.user.screen_name + "/status/" + tweet.id_str, target: '_blank', className: 'user' },
					tweet.created_at,
					React.createElement('img', { src: user.profile_image_url_https, className: 'user-profile_image' }),
					React.createElement(
						'strong',
						null,
						user.name
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'a',
							{ href: "https://twitter.com/" + user.screen_name + "/status/" + tweet.id_str, target: '_blank' },
							tweet.created_at
						)
					),
					React.createElement('div', { className: 'source', dangerouslySetInnerHTML: { __html: tweet.source.replace('<a', '<a target="_blank" ') } }),
		...
		render: function render() {
			var tweetNodes = this.props.data.map(function (tweet) {
				...
				if (tweet.retweeted_status !== undefined) {
					...
					retweetNode = React.createElement(
						'div',
						null,
						React.createElement(
							'span',
							...
							React.createElement(
								'a',
								{ href: "https://twitter.com/" + tweet.user.screen_name, target: '_blank' },
								React.createElement(
									'strong',
									null,
									tweet.user.name
				...
				return React.createElement(
					'div',
					{ className: 'collection-item', key: tweet.id },
					retweetNode,
					React.createElement(
						Tweet,
						{ tweet: tweet },
	...
	ReactDOM.render(React.createElement(TweetBox, { url: '/api/tweets' }), document.getElementById('content'));
